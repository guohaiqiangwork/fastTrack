<template>
	<view>
		<cu-custom bgColor="bg-2d-2d" :isBack="true"><block slot="content">机具统计</block></cu-custom>
		<view class="bg-2d-m pt-30" style="height: 40vh;">
			<view class="flex justify-center color-ff">
				<view class="" @click="onShowDatePicker()">{{ date[0] }} -- {{ date[1] }}</view>
				<view class="ml-20"><image style="width: 16upx;height: 10upx;" src="../../../static/images/icon/downff.png" mode=""></image></view>
			</view>
			...
			<view class="moudel_width">
				<view class="moudel_list">
					...
					<view class="flex bg-fa pt-20 pd-20 mt-30">
						<view class="flex wp-25 justify-center">
							<picker @change="PickerChange" :value="index" :range="picker" :range-key="'name'">
								<view class="picker color-99 fs-24">{{ index > -1 ? picker[index].name : '' }}</view>
							</picker>
					...
					<view class="text-center mt-30">
						<view class="fs-26 color-99">已开通(台)</view>
						<view class="fs-48 color-33 fw-700 " style="line-height: 1;">300</view>
					</view>

					<!-- 自有机具 -->
					<view class="flex mt-30">
						<view class="fs-30 color-f5 fw-700 wp_33">自有机具</view>
					...
					<view class="mt-20 border_bottom pb-20" v-if="moudelFalg">
						<view class="flex">
							<view class="fs-26 color-99 wp_33 mt-10">传统POS活动</view>
							<view class="fs-30 color-f5 wp_33 fw-700">
								<text class="fs-22 color-99 fw-600 mr-10">已开通:</text>
								300
							</view>
					...
					<!-- 代理商机具 -->
					<view class="flex mt-30">
						<view class="fs-30 color-f5 fw-700 wp_33">代理商机具</view>
						<view class="fs-30 color-f5 wp_33 fw-700">
							<text class="fs-22 color-99 fw-600 mr-10">已开通:</text>
							300
						</view>
						<view class="flex fs-22 color-99 wp_33 justify-end mt-8" @click="showM('d')">
							{{ moudelFalgD ? '详情' : '展开' }}
							<image v-if="moudelFalgD" class="ml-10 mt-18" style="width: 16upx;height: 10upx;" src="../../../static/images/icon/up99.png" mode=""></image>
							<image v-else class="ml-10 mt-18" style="width: 16upx;height: 10upx;" src="../../../static/images/icon/down99.png" mode=""></image>
						</view>
					</view>
					<!-- 隐藏内容 -->
					<view class="mt-20 border_bottom pb-20" v-if="moudelFalgD">
						<view class="flex">
							<view class="fs-26 color-99 wp_33 mt-10">传统POS活动</view>
							<view class="fs-30 color-f5 wp_33 fw-700">
								<text class="fs-22 color-99 fw-600 mr-10">已开通:</text>
				...
				<view class="moudel_bgff mt-30 pd-30">
					...
					<view v-for="(item, index) in [1, 2, 3]" :key="index" @click="goAgent" class="flex mt-30 color-33 fs-26 text-center border_bottom  pb-30">
						<view class="wp-20 fw-700">王大锤</view>
						<view class="wp-20 color-f5">200.00</view>
						<view class="wp-20">50.00</view>
						<view class="wp-20">20.00</view>
						<view class="wp-20">10.00</view>
						<view class="wp-20">10.00</view>
					</view>
				</view>
			</view>
...
export default {
	...
	methods: {
		...
		showM: function(item) {
			console.log(item);
			if (item == 'd') {
				this.moudelFalgD = !this.moudelFalgD;
			} else {
