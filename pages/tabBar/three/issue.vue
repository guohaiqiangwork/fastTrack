<template>
	<view class="pb-80">
		...
		<block v-if="model == 2">
				...
				<view class="login_moudel">
					...
					<view class="flex mt-30">
						<view class="wp-45">
							...
							<view class="mt-10" style="height: 139upx;background: #FFFFFF;border: 1px solid #A77845;"></view>
						</view>
			...
			<view class="bg-ca pt-20 pb-20 mt-30 flex justify-between color-ff fs-25">
		...
		<block v-else>
				<view class="">
					...
					<view class="login_moudel">
						...
						<view class="">名称：石家庄市金谷粮食加工厂</view>
						<view class="flex"  >
							<view class="wp-50">联系人：张三三</view>
							<view class="">电话：13022335566</view>
						</view>
						<view class="">地址：石家庄市桥西区红旗大街与南二环交口南行500米 金 谷粮食加工厂</view>		
											
					</view>
				</view>
				
				<view class="bg-ca pt-20 pb-20  flex justify-between color-ff fs-25">
					<view class="">订单号：2021122000001</view>
					<view class="">日期：2021-12-20</view>
				</view>
