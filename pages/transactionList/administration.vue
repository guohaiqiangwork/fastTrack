			...
			<view class="moudel_width">
				<view class=" moudel_bgff pt-30 pb-30 pl-30 pr-30">
					...
					<view class="text-center mt-30">
						<view class="fs-26 color-99 ">总收益(元)</view>
				...
				<view class="moudel_bgff mt-30 pt-30 pl-30 pr-30 pd-20 text-center">
					...
					<view class="flex mt-30 text-center">
						<view class="wp-50" style="border-right: 1px solid #CCCCCC;">
							<view class="fs-26 color-99 ">交易金额(元)</view>
							<view class="fs-48 color-33 fw-700" style="line-height: 1;">10000.00</view>
						</view>
						<view class="wp-50">
							<view class="fs-26 color-99 ">D0笔数(笔)</view>
							<view class="fs-48 color-33 fw-700" style="line-height: 1;">10000.00</view>
						</view>
					</view>
					<view class="flex mt-40 text-left fs-26 color-99" style="align-items: center;">
						<view class="wp_33">贷记</view>
						<view class="wp_33 flex">
							<view class="fs-22 mt-8">交易:</view>
							<view class=" color-33 fw-700 ml-10">10000</view>
						</view>
						<view class="wp_33 flex">
							<view class="fs-22  mt-8">笔数:</view>
							<view class=" color-33 fw-700 ml-10">100</view>
						</view>
					</view>
					<view class="flex  text-left fs-26 color-99" style="align-items: center;">
						<view class="wp_33">借记</view>
						<view class="wp_33 flex">
							<view class="fs-22 mt-8">交易:</view>
							<view class=" color-33 fw-700 ml-10">10000</view>
						</view>
